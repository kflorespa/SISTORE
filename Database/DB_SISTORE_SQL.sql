...
CREATE TABLE TPERFIL_USUARIO (
  IDPERFIL_USUARIO INT NOT NULL PRIMARY KEY IDENTITY(1,1),
...
ALTER TABLE TPERFIL_OPCIONES ADD CONSTRAINT FK_TPERFIL_OPCIONES_TPERFIL_USUARIO FOREIGN KEY (IDPERFIL_USUARIO) REFERENCES TPERFIL_USUARIO(IDPERFIL_USUARIO)
GO
