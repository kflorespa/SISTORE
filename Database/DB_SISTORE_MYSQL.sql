...
ON PRIMARY (NAME='DBSISTORE.MDF',FILENAME='D:DatabaseDBSISTORE.MDF',SIZE=5MB,MAXSIZE=10GB,FILEGROWTH=10%)
LOG ON (NAME='DBSISTORE_LOG.LDF',FILENAME='D:DatabaseDBSISTORE_LOG.LDF',SIZE=5MB,MAXSIZE=10GB,FILEGROWTH=10%)
GO
...
CREATE TABLE  TTABLA (
  ...
  FCHCREA DATETIME(3) DEFAULT NULL,
...
CREATE TABLE TABLADETALLE (
  ...
  FCHCREA DATETIME(3) DEFAULT NULL,
  USRCREA VARCHAR(45) DEFAULT NULL,
  FCHMOD DATETIME(3) DEFAULT NULL,
...
CREATE TABLE TUSUARIO (
  ...
  FCHNAC DATETIME(3) DEFAULT NULL,
...
ALTER TABLE TOPCIONES ADD CONSTRAINT FK_TOPCIONES_TMODULO FOREIGN KEY (IDMODULO) REFERENCES TMODULO(IDMODULO)
; 

CREATE TABLE TPERFIL_OPCIONES (
  IDPERFIL_OPCIONES INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  IDPERFIL INT DEFAULT NULL,
...
CREATE TABLE TDEPOSITO (
  IDDEPOSITO INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  ...
  FCHMOD DATETIME(3) DEFAULT NULL,
  USRMOD VARCHAR(45) DEFAULT NULL,
  FCHVEN DATETIME(3) DEFAULT NULL,
  FCHRET DATETIME(3) DEFAULT NULL
); 
...
CREATE TABLE TMOVIMIENTO (
  IDMOVIMIENTO INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  IDPROVEEDOR INT DEFAULT NULL,
  IDALMACEN INT  DEFAULT NULL,
  CODOPERACION CHAR(6) DEFAULT NULL,
  MONTOTOTAL DOUBLE DEFAULT NULL,
  FCHMOV DATETIME(3) DEFAULT NULL,
  USRCREA VARCHAR(45) DEFAULT NULL,
  FLGELI CHAR(1) DEFAULT NULL,
...
CREATE TABLE TMOVIMIENTODETALLE (
  IDMOVIMIENTODETALLE INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
  IDMOVIMIENTO INT DEFAULT NULL,
  IDPRODUCTO INT DEFAULT NULL,
  CANTIDAD CHAR(18) DEFAULT NULL,
  FECHVEN DATETIME(3) DEFAULT NULL,
  FCHCREA DATETIME(3) DEFAULT NULL,
  USRCREA VARCHAR(45) DEFAULT NULL,
  FCHMOD DATETIME(3) DEFAULT NULL,
  USRMOD VARCHAR(45) DEFAULT NULL,
